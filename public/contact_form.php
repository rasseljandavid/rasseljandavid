...
$mail->Username = 'rasseljandavid@email.com';             // SMTP username
$mail->Password = '5300721113628322';                           // SMTP password
$mail->SMTPSecure = 'tls';
$mail->Port = 587;                                    // TCP port to connect to
// Add the address to send the mail to
$mail->AddAddress('rasseljandavid@email.com');
$mail->WordWrap = 50;                                 // Set word wrap to 50 characters
$mail->IsHTML(true);                                  // Set email format to HTML

// add your company name here
$company_name = 'Rassel Jan David';
